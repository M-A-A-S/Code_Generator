...
{
    public class DataBusinessGenerator
    {
        private static string _OutputPath = @"D:\GeneratedClasses\DataBusiness";
        ...
        public static void Generate(string DatabaseName, string OutputPath)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Global.ConnectionString))
            {
                ...
                foreach (var tableName in tableNames)
                {
                    ...
                    DataBusinessFileGenerator.GenerateDataBusinessFile(tableName, _OutputPath);
                }
            }
